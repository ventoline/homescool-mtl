          ...
          <div>
            ...
            <p>
              ...
              <span className="text-gray-500">
                Le système d’école à la maison au Quebec peut être difficile à
                naviguer, entre systèmes multi niveaux, français CSSDM et
                anglais EMSB.
              </span>{" "}
            </p>{" "}
            <p>
              {" "}
              <span className="text-gray-500">
                Trouve ici les liens utiles pour connaître la réglementation,
                les ressource nécessaires disponibles et accéder des conseils
                utiles pour faire l'enseignement à la maison réseauter.
              </span>{" "}
            </p>
            <br />
            <p className="text-gray-500">
              Comme point de départ, il est avisé de se rapprocher de son école
              de quartier (
              <Link href="https://www.cssdm.gouv.qc.ca/trouver-une-ecole">
                en francais
              </Link>{" "}
              ou{" "}
              <Link href="https://apps.emsb.qc.ca/SchoolFinder/en-CA">
                anglophone
              </Link>
              ) pour des directives.{" "}
            </p>
            <p className="text-gray-500">
              Consulte la page des Outils pour trouver d'autres{" "}
              <Link href="/ressources">ressources utiles</Link>.{" "}
            </p>
            <h2>
              Les Incontournables pour naviguer l'école à la maison de Montréal.
            </h2>
          </div>
      ...
      <section className="mt-16 w-1/2 float-left">
        ...
        <ul className="space-y-2">
          <li>
            <Link
              href="/"
              className="text-blue-600 underline" /*onClick={()=> window.gtag?.("event", "goto_resources")} */
            >
              Centres de l'école a la maison - Homeschooling Montréal{" "}
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link
              href="/activites"
              className="text-blue-600 underline" /* onClick={()=> window.gtag?.("event", "goto_activities")} */
            >
