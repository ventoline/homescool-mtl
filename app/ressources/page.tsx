        ...
        <div className="grid gap-4 md:grid-cols-[2fr_1fr] p-3">
          <div>
            ...
            <p className="text-gray-500">
              Appliquer une pédagogie alternative peut s'avérer complexe à gérer
              et il est confortant de trouver les outils et programmes,
              alternatives éducatives.{" "}
            </p>
            <p className="text-gray-500">
              Ainsi qu de s'appuyer sur{" "}
              <Link href="/communaute">la communauté</Link> pour échanger sur
              les pédagogies ou réseauter et partager avec des familles qui
              partagent notre aventure.
            </p>
            <br />
            <p className="text-gray-500"></p>
            <h2> Trouve ici les liens pour naviguer l'école a la maison</h2>
          </div>
        ...
        <ul className="space-y-2">
          ...
          <li>
            <Link
              ...
              className="text-blue-600 underline" /*onClick={()=> window.gtag?.("event", "goto_resources")} */
            >
              Soutien - Communautés Homeschooling{" "}
            </Link>
          </li>
          <li>
            <Link
