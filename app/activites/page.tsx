          ...
          <div>
            ...
            <p>
              ...
              <span className="text-gray-500">
                L'emploi du temps de l'enfant hors système scolaire offre une
                multitude de possibilités. Que ce soit en complément de
                l'éducation à la maison, ou en soutien scolaire.
              </span>
            </p>
            <p>
              <span className="text-gray-500">
                {" "}
                Il existe des services adaptés aux besoins et envie des
                homeschoolers!
              </span>{" "}
            </p>
            <br />
            <p></p>
            <h2> Les meilleures activités pour homeschoolers a Montréal!</h2>
          </div>
      ...
      <section className="mt-16 w-1/2 float-left">
        ...
        <ul className="space-y-2">
          <li>
            ...
            >
              Centres de l'école a la maison - Homeschooling a Montréal{" "}
            </Link>
          </li>{" "}
          <li>
            <Link
              ...
              className="text-blue-600 underline" /*onClick={()=> window.gtag?.("event", "goto_resources")} */
            >
              Ressources - Outils pour l'école a la maison - Homeschooling{" "}
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              Soutient - Communautés Homeschooling
            </Link>
          </li>
        </ul>
      </section>
